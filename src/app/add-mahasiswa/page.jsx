                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-lg shadow-lg">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-md border border-gray-200 focus:border-blue-500 focus:border-2 focus:ring-blue-200  transition duration-200 text-gray-700"
                            required
                    ...
                    <div className="space-y-2">
                            ...
                            {({ open }) => {
                                return (
                                    <button
                                        ...
                                        className="w-full bg-blue-500 text-white py-3 px-6 rounded-md hover:bg-blue-600 transition duration-200 fonr-medium shadow-sm"
                                    >
                                        Upload Foto
                                    </button>
                                );
                        ...
                        {foto && (
                            <p className="mt-2 text-sm tex-green-600 font-medium flex items-center">
                                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 l3l4 4L19 7"></path>
                                </svg>
